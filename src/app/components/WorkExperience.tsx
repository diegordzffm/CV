    ...
    <Card className="py-0 print:py-0">
      <CardHeader className="print:space-y-1">
        <div className="flex items-center justify-between gap-x-2 text-base">
          <h3 className="inline-flex text-orange-500 items-center justify-center gap-x-1 font-semibold leading-none print:text-sm">
        ...
        <h4 className="font-sans-serif text-sm text-orange-500 font-semibold leading-none print:text-[12px] ">
          {title}
        </h4>
      </CardHeader>
