...
function ProjectLink({ title, link }: ProjectLinkProps) {
  ...
  return (
    <>
      ...
      <div
        className="hidden font-sans-serif text-xs underline print:visible"
        aria-hidden="true"
      >
    ...
    >
      <CardHeader>
        <div className="space-y-1">
          ...
          <CardDescription
            className="text-pretty font-sans-serif text-s print:text-[10px]"
